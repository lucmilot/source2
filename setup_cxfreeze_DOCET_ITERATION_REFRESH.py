...
#run on the directory where the py is : 
#python setup_cxfreeze_DOCET_ITERATION_REFRESH.py build > cxfreeze_result.txt
...
setup(  name = "DOCET_ITERATION_REFRESH_V2",
        ...
        executables = [Executable("DOCET_ITERATION_REFRESH.py", base=base)])
